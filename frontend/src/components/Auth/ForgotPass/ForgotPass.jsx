...
// //         try {
// //             if (method === "email") {
// //                 const response = await fetch(`https://test-api.klezy.com/api/otp/change-password/send-otp`, {
// //                     method: "POST",
...
// //         try {
// //             if (method === "email") {
// //                 const response = await fetch(`https://test-api.klezy.com/api/otp/verify-otp`, {
// //                     method: "POST",
// //                     headers: { "Content-Type": "application/json" },
...
// //         try {
// //             const response = await fetch(`https://test-api.klezy.com/api/auth/change-password`, {
// //                 method: "PATCH",
// //                 headers: { "Content-Type": "application/json" },
...
//                     </div>
//                     <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 w-full max-w-xs sm:max-w-sm md:max-w-md z-10">
//                         <div className="flex flex-col mb-2 items-center gap-2 sm:gap-3">
//                             <h2 className="text-lg sm:text-xl font-semibold text-gray-800 text-center">
//                                 Forgot Password
//                             </h2>
//                             <p className="text-xs sm:text-sm text-gray-500 mb-4 sm:mb-6 text-center font-sans">
//                                 Enter your credentials to set new password
//                             </p>
//                         </div>
//                         <div className="text-xs sm:text-sm text-left text-red-500 font-medium">
//                             <p>{formError}</p>
//                         </div>
//                         {step === 1 && (
//                             <div>
//                                 <div className="mb-3 sm:mb-4 text-left">
//                                     <label className="block font-medium mb-1 sm:mb-2 text-black opacity-[73%] text-xs sm:text-sm">
//                                         Reset using
//                                     </label>
...
//                                             }}
//                                             className={`w-full flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-4 py-1 sm:py-1.5 text-xs sm:text-sm font-semibold ${method === "phone"
//                                                 ? "bg-purple-600 text-white rounded-lg"
//                                                 : "text-gray-500"
//                                                 }`}
//                                         >
//                                             <span className="text-sm sm:text-lg"><LuPhone /> </span> Phone
//                                         </button>
//                                         <button
//                                             type="button"
//                                             onClick={() => {
...
//                                                 setErrors((prev) => ({ ...prev, emailOrPhone: "" }));
//                                             }}
//                                             className={`w-full flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-4 py-1 sm:py-1.5 text-xs sm:text-sm font-semibold ${method === "email"
//                                                 ? "bg-purple-600 text-white rounded-lg"
//                                                 : "text-gray-500"
//                                                 } transition-all duration-200`}
//                                         >
//                                             <span className="text-sm sm:text-lg"><MdOutlineMail /> </span> Email
//                                         </button>
//                                     </div>
//                                 </div>
//                                 {method === "phone" ? (
//                                     <div className="text-left mb-3 sm:mb-4">
//                                         <label className="flex items-center gap-1 font-medium mb-1 sm:mb-2 text-black opacity-[73%] text-xs sm:text-sm">
//                                             Phone number
//                                             {errors.emailOrPhone && (
//                                                 <p className="text-red-500 text-xs sm:text-sm">{errors.emailOrPhone ? "*" : ""}</p>
//                                             )}
//                                         </label>
//                                         <PhoneInput
//                                             country={"in"}
...
//                                             }}
//                                             containerClass="w-full"
//                                             inputClass={`w-full h-10 sm:h-12 px-3 sm:px-4 text-sm sm:text-base text-gray-900 border ${errors.emailOrPhone ? "border-red-500" : "border-gray-300"
...
//                                             inputStyle={{ height: "40px", width: "100%", border: "1px #e5e7eb solid", fontSize: "14px" }}
//                                             buttonStyle={{
//                                                 position: "absolute",
//                                                 left: "5px",
//                                                 top: "5px",
...
//                                                 setErrors((prev) => ({ ...prev, emailOrPhone: "" }));
//                                             }}
//                                             className={`w-full h-10 sm:h-12 px-3 sm:px-4 text-sm sm:text-base border ${errors.emailOrPhone ? "border-red-500" : "border-gray-200"
//                                                 } rounded-lg focus:outline-none focus:ring-1 focus:ring-purple-500`}
//                                             placeholder="Enter your email"
//                                         />
//                                     </div>
...
//                                         <label className="flex items-center gap-1 font-medium mb-2 text-black opacity-[73%] text-xs sm:text-sm">
//                                             Enter OTP
//                                             {errors.otp && (
//                                                 <p className="text-red-500 text-xs sm:text-sm">{errors.otp ? "*" : ""}</p>
//                                             )}
//                                         </label>
//                                         <OtpInput
//                                             value={otp}
...
//                                                         }
//                                                     }}
//                                                     className="w-8 h-8 sm:w-12 sm:h-12 text-sm sm:text-xl"
//                                                 />
//                                             )}
//                                         />
//                                     </div>
//                                 )}
//                                 <div className="w-full text-start text-xs mb-3 sm:mb-4">
//                                     {!showOtpInput ? (
//                                         <></>
//                                     ) : (
//                                         <button
//                                             onClick={(e) => handleSendOtp(e, true)}
//                                             disabled={resendDisabled}
//                                             className={`w-fit border-b border-[#5E0194] transition-all duration-300 text-xs sm:text-sm ${resendDisabled
...
//                                     )}
//                                 </div>
//                                 <div className="w-full text-end text-xs mb-3 sm:mb-4">
//                                     {!showOtpInput ? (
//                                         <button
//                                             onClick={handleSendOtp}
//                                             className="bg-[#A100FF] text-white w-full p-2.5 sm:p-3 rounded-lg shadow-md hover:shadow-purple-400 hover:bg-purple-600 mx-auto transition-all duration-300 text-sm sm:text-lg font-semibold flex items-center justify-center"
...
//                                         <button
//                                             onClick={handleVerifyOtp}
//                                             className={`w-full p-2.5 sm:p-3 rounded-lg shadow-md mx-auto text-sm sm:text-lg font-semibold flex items-center justify-center ${otp.length === 6 ? "bg-[#A100FF] text-white hover:shadow-purple-400 hover:bg-purple-600" : "bg-gray-300 text-gray-700"} transition-all duration-300`}
...
//                                         <label className="flex items-center gap-1 font-medium mb-1 text-black opacity-[73%] text-xs sm:text-sm">
//                                             New Password *
//                                         </label>
//                                         <input
//                                             type={showPassword ? "text" : "password"}
...
//                                             }}
//                                             className={`w-full h-10 sm:h-12 px-3 sm:px-4 text-sm sm:text-base border ${errors.password ? "border-red-500" : "border-gray-200"
//                                                 } rounded-lg focus:outline-none focus:ring-1 focus:ring-purple-500`}
//                                             placeholder="Enter new password"
//                                         />
//                                         <button
//                                             type="button"
//                                             onClick={() => setShowPassword(!showPassword)}
//                                             className="absolute right-2 sm:right-3 top-8 sm:top-9 text-gray-500"
//                                         >
...
//                                             }}
//                                             className={`w-full h-10 sm:h-12 px-3 sm:px-4 text-sm sm:text-base border ${errors.confirmPassword ? "border-red-500" : "border-gray-200"
//                                                 } rounded-lg focus:outline-none focus:ring-1 focus:ring-purple-500`}
//                                             placeholder="Confirm new password"
//                                         />
//                                         <button
...
//                                             className="absolute right-2 sm:right-3 top-8 sm:top-9 text-gray-500"
//                                         >
//                                             {showConfirmPassword ? <FaEyeSlash size={16} className="sm:w-[18px] sm:h-[18px]" /> : <FaEye size={16} className="sm:w-[18px] sm:h-[18px]" />}
//                                         </button>
//                                     </div>
...
//                                 <button
//                                     onClick={handleResetPassword}
//                                     className="bg-[#A100FF] text-white w-full p-2.5 sm:p-3 rounded-lg shadow-md hover:shadow-purple-400 hover:bg-purple-600 mx-auto transition-all duration-300 text-sm sm:text-lg font-semibold"
//                                 >
//                                     Reset Password
//                                 </button>
//                             </div>
//                         )}
//                         {step === 1 && (
//                             <p className="text-gray-500 opacity-[99%] text-xs sm:text-sm text-center mt-3 sm:mt-4">
