...
const AccountSettings = ({ onClose }) => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        setLoading(true);
        const response = await fetch("https://test-api.klezy.com/api/edit-profile/get-profile-data", {
          method: "GET",
          credentials: "include",
        });
  ...
  const handleSendEmailOTP = async (e) => {
    ...
    try {
      const response = await fetch("https://test-api.klezy.com/api/otp/send-otp", {
        method: "POST",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://test-api.klezy.com/api/edit-profile/", {
        method: "PATCH",
        credentials: "include",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
